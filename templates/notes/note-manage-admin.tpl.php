...
if (isset($url) && !empty($url)) {
    echo '<a href="/manual/en/', urlencode(htmlspecialchars($url)), '">Return to manual</a>';
}
?>
...
<tr>
 <th class="form-label_left">Approve</th>
 <td class="form-input"><input type="submit" name="approve" value="Approve selected comments" /></td>
 <td class="form-input"></td>
</tr>
<tr>
 <th class="form-label_left">Delete</th>
 <td class="form-input"><input type="submit" name="delete" value="Delete selected comments" /></td>
 <td class="form-input"></td>
</tr>
</table>
</form>
