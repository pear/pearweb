...
$phpt->assertTrue(user::isQA('cellog'), 'test');
$phpt->assertFalse(user::isQA('blah'), 'test 2');
$phpt->assertTrue(user::isAdmin('cellog'), 'test3');
$phpt->assertFalse(user::isAdmin('blah'), 'test 4');
