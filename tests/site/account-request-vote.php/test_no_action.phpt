--TEST--
account-request-vote.php |  No Request has been made
--FILE--
<?php
// setup
$_SERVER['SERVER_NAME'] = 'localhost';
$_SERVER['HTTP_HOST'] = 'localhost';
$_SERVER['PHP_SELF'] = '/account-request-vote.php';
...
<a name="requestform" id="requestform"></a><form action="account-request-vote.php#requestform" method="post" >
