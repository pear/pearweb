...
--POST--
email=dufuz@php.net&firstname=Helgi&lastname=Thormar&password=hi&password2=hi&comments_read=1&handle=helgi1&captcha=24&submit=1&moreinfo=&homepage=
--FILE--
<?php
// setup
...
$mock->addDataQuery('SELECT * FROM users WHERE handle = \'helgi1\'',
            array(),
...
$mock->addInsertQuery('INSERT INTO users
            ...
            VALUES
                (\'helgi1\', \'Helgi Thormar\', \'dufuz@php.net\', \'\', 0, \'49f68a5c8493ec2c0bf489821c21fc3b\', 0, \'a:2:{i:0;s:24:"vote in general election";i:1;s:0:"";}\', "pear")',
                array(), array());
...
$phpt->assertEquals(array (
 ...
 2 => 'SELECT * FROM users WHERE handle = \'helgi1\'',
 3 => '
            INSERT INTO users
                (handle, name, email, homepage, showemail, password, registered, userinfo, from_site)
            VALUES
...
<a name="requestform" id="requestform"></a><div class="errors">ERROR:<ul><li>Database error (e.g. email address already registered).</li>
</ul></div>
