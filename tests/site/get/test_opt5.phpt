...
$_SERVER['REQUEST_URI'] = '/get/Archive_Tar';
$_SERVER['QUERY_STRING'] = '';
$_SERVER['PATH_INFO'] = '/Archive_Tar';
require dirname(__FILE__) . '/setup.php.inc';
require dirname(__FILE__) . '/test_opt.setup5.php.inc';
...
$phpt->assertEquals(array (
  ...
  1 => 'SELECT id FROM releases WHERE package = 1 ORDER BY releasedate DESC',
