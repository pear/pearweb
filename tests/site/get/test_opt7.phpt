...
$_SERVER['REQUEST_URI'] = '/get/Archive_Tar-1.3.2.tar';
$_SERVER['QUERY_STRING'] = '';
$_SERVER['PATH_INFO'] = '/Archive_Tar-1.3.2.tar';
...
Content-disposition: attachment; filename="Archive_Tar-1.3.2.tar"
--EXPECTFILE--
packages/Archive_Tar-1.3.2.tar
