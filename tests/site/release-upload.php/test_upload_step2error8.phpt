...
upload=1
--UPLOAD--
distfile=test_upload_step2/Archive_Tar-1.0.0.tgz
--FILE--
<?php
// setup
...
<!-- START MAIN CONTENT -->
  ...
  <td class="content">
    ...
    <div class="errors">ERRORS:<br />You must correct your package.xml file:<ul><li>Version 1.0.0 must be stable</li>
</ul></div>
