--TEST--
release-upload.php [upload, file is not tgz]
--COOKIE--
PEAR_USER=cellog;PEAR_PW=hi
--POST--
upload=1
--UPLOAD--
distfile=test_upload_step1error2.phpt
--FILE--
<?php
// setup
...
<div class="errors">ERROR:<ul><li>Upload error: File extension not permitted.</li>
</ul></div>
<p>
