--TEST--
release-upload.php [upload success, version rc is lowercased]
--COOKIE--
PEAR_USER=cellog;PEAR_PW=hi
--POST--
upload=1
--UPLOAD--
distfile=test_upload_step2/Archive_Tar-1.0.0rc1.tgz
--FILE--
<?php
// setup
...
<!-- START MAIN CONTENT -->
  ...
  <td class="content">
    ...
    <div class="errors">ERRORS:<br />You must correct your package.xml file:<ul><li>Release Candidate versions MUST use upper-case RC versioning, not rc</li>
</ul></div>
