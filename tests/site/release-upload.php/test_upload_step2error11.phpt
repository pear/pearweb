--TEST--
release-upload.php [upload success, version is 0.0.X]
--COOKIE--
PEAR_USER=cellog;PEAR_PW=hi
--POST--
upload=1
--UPLOAD--
distfile=test_upload_step2/Archive_Tar-0.0.1.tgz
--FILE--
<?php
// setup
...
<!-- START MAIN CONTENT -->
  ...
  <td class="content">
    ...
    <div class="errors">ERRORS:<br />You must correct your package.xml file:<ul><li>Version 0.0.X is invalid, use 0.X.0</li>
</ul></div>
