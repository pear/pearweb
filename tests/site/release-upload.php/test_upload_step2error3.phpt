--TEST--
release-upload.php [upload, no package.xml]
--COOKIE--
...
copy(dirname(__FILE__) . '/test_upload_step2/Archive_Tar-1.3.2-bad.tgz',
...
<div class="errors">ERROR:<ul><li>could not extract the package.xml file from &quot;/var/tmp/pear/uploads/Archive_Tar-1.3.2-bad.tgz&quot;</li>
</ul></div>
<p>
