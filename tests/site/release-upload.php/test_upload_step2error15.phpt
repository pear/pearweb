--TEST--
release-upload.php [upload error, package.xml is in package.xml]
--COOKIE--
PEAR_USER=cellog;PEAR_PW=hi
--POST--
upload=1
--UPLOAD--
distfile=test_upload_step2/Archive_Tar-1.3.3.tgz
--FILE--
<?php
// setup
...
<!-- START MAIN CONTENT -->
  ...
  <td class="content">
    ...
    <div class="warnings">RECOMMENDATIONS:<br />You may want to correct your package.xml file:<ul><li>package.xml should not be present in package.xml, installation may fail</li>
</ul></div>
