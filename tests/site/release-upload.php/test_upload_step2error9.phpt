--TEST--
release-upload.php [upload success, version RC != beta]
--COOKIE--
...
<!-- START MAIN CONTENT -->
  ...
  <td class="content">
    ...
    <div class="errors">ERRORS:<br />You must correct your package.xml file:<ul><li>Release Candidate versions must have stability beta</li>
</ul></div>
