--TEST--
release-upload.php [upload error, package.xml is version 1.0]
--COOKIE--
PEAR_USER=cellog;PEAR_PW=hi
--POST--
upload=1
--UPLOAD--
distfile=test_upload_step2/Archive_Tar-1.3.1.tgz
--FILE--
<?php
// setup
...
<!-- START MAIN CONTENT -->
  ...
  <td class="content">
    ...
    <div class="errors">ERRORS:<br />You must correct your package.xml file:<ul><li>Only packages using package.xml version 2.0 or newer may be released - use the &quot;pear convert&quot; command to create a new package.xml</li>
</ul></div>
...
loaded. Bz2 compression is also supported with the bz2 extension loaded.<br />
