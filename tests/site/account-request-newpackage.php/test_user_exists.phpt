--TEST--
account-request-newpackage.php | [User already exists]
--POST--
purpose=Smurf a lot&newpackage=Foo&email=dufuz@php.net&firstname=Helgi&lastname=Thormar&password=hi&password2=hi&comments_read=1&handle=helgi&captcha=24&submit=1
--FILE--
<?php
// setup
