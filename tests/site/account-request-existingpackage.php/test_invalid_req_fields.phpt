--TEST--
account-request-existingpackage.php | [Invalid required fields]
--POST--
existingpackage=Foo&purposecheck[0]=1&submit=1
--FILE--
<?php
// setup
...
<a name="requestform" id="requestform"></a><div class="errors">ERROR:<ul><li>Username is invalid.</li>
<li>Obviously you did not read all the comments concerning the need for an account. Please read them again.</li>
<li>The purpose(s) you selected do not require a PEAR account.</li>
<li>Incorrect CAPTCHA</li>
<li>Package &quot;Foo&quot; does not exist, please choose a pre-existing package name</li>
</ul></div>
...
<table class="form-holder" cellspacing="1">
 ...
 <tr>
  ...
  <td class="form-input">
   <input type="text" name="existingpackage" size="20" value="Foo" />
  </td>
 </tr>
 <tr>
  <th class="form-label_left">Purpose of your PEAR account:<p class="cell_note">(Check all that apply)</p></th>
  <td class="form-input">
  <input type="checkbox" name="purposecheck[0]" checked="checked" />
