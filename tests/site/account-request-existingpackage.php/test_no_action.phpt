...
<a name="requestform" id="requestform"></a><form action="account-request-existingpackage.php#requestform" method="post" >
<table class="form-holder" cellspacing="1">
 ...
 <tr>
  ...
  <td class="form-input">
   <input type="text" name="existingpackage" size="20" value="" />
  </td>
 </tr>
 <tr>
