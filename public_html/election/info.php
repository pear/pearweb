...
if (!isset($auth_user) || !$auth_user) {
    if (isset($_GET['vote'])) {
        ...
        require PEARWEB_TEMPLATEDIR . '/templates/election-register.tpl.php';
...
if (isset($_POST['confirm'])) {
    ...
    if (isset($_POST['abstain'])) {
        ...
        if (count($_POST['vote']) < $info['minimum_choices'] ||
            ...
            require PEARWEB_TEMPLATEDIR . '/templates/election-dovote.tpl.php';
            exit;
        }
        $info['abstain'] = false;
    ...
    require PEARWEB_TEMPLATEDIR . '/templates/election-confirm.tpl.php';
    exit;
}
...
if (isset($_POST['finalvote'])) {
    ...
    require PEARWEB_TEMPLATEDIR . '/templates/election-confirmed.tpl.php';
...
if (isset($_GET['vote'])) {
    ...
    if ($voter->hasVoted($_GET['election'])) {
        ...
        require PEARWEB_TEMPLATEDIR . '/templates/election-pending.tpl.php';
    } elseif ($voter->canVote($_GET['election'])) {
        require PEARWEB_TEMPLATEDIR . '/templates/election-dovote.tpl.php';
    } else {
        $info = $voter->electionInfo($_GET['election']);

        require PEARWEB_TEMPLATEDIR . '/templates/election-showresults.tpl.php';
    }
}
