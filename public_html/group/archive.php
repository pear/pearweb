...
/*
   ...
   +----------------------------------------------------------------------+
   | Copyright (c) 2008 The PEAR Group                                    |
   +----------------------------------------------------------------------+
   ...
   $Id$
*/
response_header('The PEAR Group - Archive');
?>

<h1>The PEAR Group - Archive</h1>
...
<h2>Group of August 12th, 2003 until May 1st, 2007</h2>
<p>
 This is the first PEAR group that Stig <a href="http://marc.info/?l=pear-dev&m=106073080219083&w=2">announced</a>
 back in 2003 but did not follow the same governing pattern as other groups after it did.
</p>
<ul>
  <li><a href="/user/lsmith" title="Lukas Smith">Lukas Smith</a> </li>
  <li><a href="/user/mj" title="Martin Jansen">Martin Jansen</a></li>
  <li><a href="/user/ssb" title="Stig S. Bakken">Stig S. Bakken</a> </li>
  <li><a href="/user/jon" title="Jon Parise">Jon Parise</a></li>
  <li><a href="/user/cox" title="Tomas V.V.Cox">Tomas V.V.Cox</a></li>
  <li><a href="/user/alank" title="Alan Knowles">Alan Knowles</a></li>
  <li><a href="/user/pajoye" title="Pierre-Alain Joye">Pierre-Alain Joye</a></li>
  <li><a href="/user/jmcastagnetto" title="Jesus M. Castagnetto">Jesus M. Castagnetto</a></li>
</ul>
